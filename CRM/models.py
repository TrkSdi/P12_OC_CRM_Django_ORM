...
class Client(models.Model):
    ...
    sales_contact = models.ForeignKey(AUTH_USER_MODEL,
                                      limit_choices_to=Q(role='Vente') | Q(role='Gestion'),
                                      on_delete=models.PROTECT,
                                      default=None, verbose_name="Contact")
...
class Lead(models.Model):
    ...
    sales_contact = models.ForeignKey(AUTH_USER_MODEL,
                                      limit_choices_to=Q(role='Vente') | Q(role='Gestion'),
                                      on_delete=models.PROTECT, verbose_name="Contact")
...
class Contract(models.Model):
    ...
    sales_contact = models.ForeignKey(AUTH_USER_MODEL, on_delete=models.PROTECT,
                                      null=True, blank=True, default=None, verbose_name="Contact")
...
class Event(models.Model):
    ...
    date_created = models.DateTimeField("Date de création", auto_now_add=True)
    date_updated = models.DateTimeField("Mis à jour le", auto_now=True)
    support_contact = models.ForeignKey(AUTH_USER_MODEL,
                                        limit_choices_to=Q(role='Support') | Q(role='Gestion'),
                                        on_delete=models.PROTECT, verbose_name="Contact")
